      ...
      <main>
        ...
        <section className="relative h-screen min-h-[900px] bg-[#1C1A17] overflow-hidden">
          ...
          <div className="absolute bottom-[12%] left-20 max-w-[590px]">
            <h1 className="font-cormorant font-light text-[64px] leading-[1.05] tracking-[-1px] text-white mb-8">
              Dressed for<br />
        ...
        <section className="bg-[#FBF9FF] px-16 py-12">
          <div className="flex items-end justify-between mb-16">
            <div>
              ...
              <h2 className="font-shippori text-[52px] tracking-[-0.5px] text-[#01002D]">訂製展示</h2>
            </div>
        ...
        {/* About */}
        <section id="about" className="grid grid-cols-2 min-h-[934px]">
          <div className="relative bg-gradient-to-br from-[#1C1A17] to-[#030081]" />
          <div id="fabric" className="bg-[#F2EDFE] flex flex-col justify-center px-20 py-24">
            <p className="suun-label mb-6">職人製</p>
            <h2 className="font-shippori text-[52px] tracking-[-0.5px] text-[#01002D] leading-[1.1] mb-10">如何挑選適合的布料</h2>
        ...
        <section id="process" className="bg-[#D9D9EC] px-16 py-28">
          <div className="text-center mb-20">
            ...
            <h2 className="font-shippori text-[52px] tracking-[-0.5px] text-[#01002D] mb-4">量身訂做<br />個人風格</h2>
        ...
        <section id="booking" className="grid grid-cols-2 min-h-[732px]">
          <div className="relative bg-gradient-to-br from-[#030081] to-[#01002D]" />
          <div className="bg-[#01002D] flex flex-col justify-center px-20 py-20">
            <p className="font-inter font-medium text-[10px] tracking-[4px] uppercase text-[#AFD9F2] mb-8">預約製衣</p>
            ...
            <div className="font-inter font-light text-[14px] leading-[1.8] text-[rgba(255,255,255,0.5)] mb-10">
