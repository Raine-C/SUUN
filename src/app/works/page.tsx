      ...
      <main className="pt-20">
        <section className="relative h-[604px] bg-[#1C1A17] overflow-hidden">
          ...
          <div className="absolute bottom-24 left-16 max-w-[400px]">
            ...
            <h1 className="font-shippori text-[64px] tracking-[-0.5px] leading-[1.1] text-white mb-8">每一件，<br />只為你而生</h1>
            <p className="font-inter font-light text-[14px] leading-[1.8] text-[rgba(255,255,255,0.6)]">所有作品均為個人全手工訂製，不量產、不複製，每件西服都是獨一無二的存在。</p>
          </div>
        </section>

        <section className="bg-[#FBF9FF] min-h-screen">
          <div className="max-w-[1440px] mx-auto flex">
            <aside className="w-[284px] shrink-0 px-16 py-16 border-r border-[#D9D9EC]">
            ...
            <div className="flex-1 px-16 py-16">
              <p className="font-inter text-[15px] text-[#5F5971] mb-8">共 {works.length || 9} 件作品</p>
